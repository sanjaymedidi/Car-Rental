          ...
          <div className={styles.infoCard}>
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  { icon: FaWhatsapp, label: 'WhatsApp', value: '+91 6300862619', color: 'bg-green-900/30' },
                  { icon: FaEnvelope, label: 'Email', value: 'charnsivasanjaymedidi.com', color: 'bg-orange-900/30' },
